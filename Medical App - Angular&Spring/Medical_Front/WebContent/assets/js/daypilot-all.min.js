...
;(function () {
    ...
    (function registerAngularModule() {
        ...
        $1C.directive("daypilotCalendar", ['$parse', function ($1D) {
            return {
                "restrict": "E", "template": "<div></div>", "replace": true, "link": function ($1E, element, $1F) {
...
;(function () {
        ...
        this.drawTop = function () {
            ...
            $02.onmousemove = function (ev) {
                if (DayPilotMonth.resizingEvent) {
                    ...
                    ;
                    var $08 = $06 < $07 ? $W : $L;
                    DayPilotMonth.timeRangeSelecting.from = {x: $08.x, y: $08.y};
    ...
    (function registerAngularModule() {
        ...
        $0Q.directive("daypilotMonth", ['$parse', function ($0R) {
            return {
                "restrict": "E", "template": "<div></div>", "replace": true, "link": function ($0S, element, $0T) {
